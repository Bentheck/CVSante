...
namespace CVSante.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public bool AcceptRecaptcha { get; set; }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirmez votre adresse e-mail",
                        $"Veuillez confirmer votre compte en cliquant <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>ici</a>.");
        ...
        private IdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Impossible de créer une instance de '{nameof(IdentityUser)}'. " +
                    $"Assurez-vous que '{nameof(IdentityUser)}' n'est pas une classe abstraite et possède un constructeur sans paramètre, ou bien " +
        ...
        private IUserEmailStore<IdentityUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("L'interface utilisateur par défaut nécessite un magasin d'utilisateurs prenant en charge les e-mails.");
            }
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            if (user == null)
            {
                ModelState.AddModelError(string.Empty, "Email de vérification envoyé. Veuillez vérifier votre boîte de réception.");
                return Page();
            }
